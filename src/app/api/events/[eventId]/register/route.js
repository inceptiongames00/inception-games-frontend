...
export async function POST(request, { params }) {
  try {
    ...
    console.log('[Event Registration API] Event ID:', eventId);
    ...
    if (!response.ok) {
      ...
      console.error('[Event Registration API] Backend error:', error);
      return NextResponse.json({ 
        success: false, 
    ...
    console.log('[Event Registration API] Backend response:', result);
