  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://inception-games.an.r.appspot.com/api/v1/contact/partner-apply",
        {
          method: "POST",
          headers: {
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="relative overflow-hidden">
            {partners.map((partner, idx) => (
              ...
              >
                {/* Background */}
                <div
                  className={`relative bg-gradient-to-r ${partner.bgGradient} backdrop-blur-xl bg-cover bg-center h-[500px] sm:h-[600px]`}
                  style={{
          ...
          {/* Left Side Button - Apply for Partnership */}
          <motion.button
